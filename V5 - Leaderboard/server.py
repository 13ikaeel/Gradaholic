...
def profile():
	if request.method=="GET":
		...
		db.close()
		return render_template('profile.html', username=username, school_rank='NIL', avgrp=avgrp, mode_grade=mode_grade, distinctions=distinctions, failures=failures, submissions=submissions, date=date[:10], rank='NIL', history=history)
